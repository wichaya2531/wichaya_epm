...
const ExportButtons = ({ handleExport, excel = false }) => {
  return (
    <div className="flex justify-end mt-6 space-x-3">
      ...
      {excel && (
        <button
          ...
          className=" bg-green-700 hover:bg-green-800 text-white font-bold py-2 px-4 rounded-md transition duration-300 transform hover:scale-105 flex items-center justify-center space-x-2"
        >
          <ExcelIcon />
