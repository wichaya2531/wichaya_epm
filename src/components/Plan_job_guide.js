  ...
  return (
    <div className="relative w-[1000px] mx-auto">
      ...
      >
        <SwiperSlide>
          <center>
              <img src="/help_image/planning/1.png" alt="Slide 1" className="w-[900px] h-auto" />
          </center>
        </SwiperSlide>
        <SwiperSlide>
          <center>
            <img src="/help_image/planning/2.png" alt="Slide 2" className="w-[900px] h-auto" />
          </center>
        </SwiperSlide>
        <SwiperSlide>
         <center>
              <img src="/help_image/planning/3.png" alt="Slide 3" className="w-[900px] h-auto" />
          </center>
           
        </SwiperSlide>
        <SwiperSlide>
          <center>
               <img src="/help_image/planning/4.png" alt="Slide 4" className="w-[900px] h-auto" />       
          </center>
        </SwiperSlide>
        <SwiperSlide>
          <center>
              <img src="/help_image/planning/5.png" alt="Slide 5" className="w-[900px] h-auto" />
          </center>    
        </SwiperSlide>
      </Swiper>
